...
> Course Design Version of BusinessInsight Agent
...
- [Product Ads Method](README_COURSE.md)：商品级广告方法、公式和实验设计
- [Final Course Report](docs/course_report_final.md)：最终课程报告正文
...
默认 `AGENT_RUNNER=sequential`，使用项目内置轻量条件 runner。它没有额外依赖，适合本地开发、CI 和课程演示。
